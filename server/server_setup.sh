...
git config --global user.email "rikard.fahlstrom@gmail.com"
git config --global user.name "Rikard Fahlstrom"
...
# clone the repo:
cd /apps
git clone https://github.com/RikardFahlstrom/pypi-demo-site app_repo
...
certbot --nginx -d www.rikardfahlstrom.com